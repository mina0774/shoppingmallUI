...
import com.example.heronation.home.itemRecyclerViewAdapter.ItemHorizontalAdapter;
import com.example.heronation.home.itemRecyclerViewAdapter.dataClass.ShopItem;
...
public class WishlistRecentlyViewedItemHaveFragment extends Fragment {
    ...
    @BindView(R.id.recycler_view_recently_viewed_item) RecyclerView item_recyclerView;
